export default function AboutPage() {
  return (
    <div className="min-h-screen bg-[#F6F5F3] font-league-spartan flex flex-col items-center">
      <main className="w-full max-w-4xl bg-white rounded-3xl shadow-2xl mt-6 sm:mt-10 mb-4 sm:mb-10 overflow-hidden px-0">
        {/* Hero Section */}
        <section className="px-4 sm:px-8 pt-10 sm:pt-12 pb-4 sm:pb-6 text-center">
          <h1 className="text-2xl sm:text-4xl font-extrabold text-[#171717] mb-3 sm:mb-4">About SnapSpaces</h1>
        ...
        <section className="px-4 sm:px-8 py-6 sm:py-10 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8">
          <div className="bg-[#F6F5F3] rounded-2xl shadow p-4 sm:p-6 flex flex-col items-center text-center">
            <svg className="w-8 h-8 sm:w-10 sm:h-10 mb-3 sm:mb-4 text-yellow-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M12 2a10 10 0 1 1 0 20 10 10 0 0 1 0-20zm0 0v10l6 3" /></svg>
            <h2 className="text-lg sm:text-xl font-bold text-[#171717] mb-1 sm:mb-2">Our Mission</h2>
          ...
          <div className="bg-[#F6F5F3] rounded-2xl shadow p-4 sm:p-6 flex flex-col items-center text-center">
            <svg className="w-8 h-8 sm:w-10 sm:h-10 mb-3 sm:mb-4 text-yellow-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" /><path d="M12 6v6l4 2" /></svg>
            <h2 className="text-lg sm:text-xl font-bold text-[#171717] mb-1 sm:mb-2">Our Vision</h2>
        ...
        <section className="px-4 sm:px-8 py-6 sm:py-10 flex flex-col md:flex-row items-center gap-6 sm:gap-10">
          <div className="flex-1">
            <h2 className="text-xl sm:text-2xl font-bold text-[#171717] mb-3 sm:mb-4">Our Story</h2>
          ...
          <div className="flex-1 flex justify-center mt-6 md:mt-0">
            <div className="w-32 h-32 sm:w-48 sm:h-48 bg-[#CBC8C8] rounded-2xl flex items-center justify-center shadow-lg">
              <svg className="w-16 h-16 sm:w-24 sm:h-24 text-yellow-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><rect x="3" y="7" width="18" height="13" rx="2" /><path d="M16 3v4M8 3v4M3 10h18" /></svg>
            </div>
          </div>
        </section>
        ...
        <section className="px-4 sm:px-8 py-6 sm:py-10">
          <h2 className="text-xl sm:text-2xl font-bold text-[#171717] mb-6 sm:mb-8 text-center">What Makes Us Different</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8">
            <div className="bg-white rounded-2xl shadow p-4 sm:p-6 flex flex-col items-center text-center">
