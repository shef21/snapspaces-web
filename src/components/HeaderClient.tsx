...
export default function HeaderClient() {
  ...
  return (
    <header className="sticky top-0 z-30 w-full bg-[#CBC8C8]/90 backdrop-blur border-b border-[#CBC8C8] shadow-sm">
      <nav className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-8 py-3 relative">
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="absolute top-full left-0 w-full bg-[#CBC8C8] border-b border-[#CBC8C8] shadow-lg flex flex-col gap-2 py-4 z-40 animate-fade-in">
